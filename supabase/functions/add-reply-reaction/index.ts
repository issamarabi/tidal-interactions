/**
 * POST /add-reply-reaction
 *
 * **Example cURL**
 * ```bash
 * curl -X POST https://your-project.supabase.co/functions/v1/add-reply-reaction \
 ...
 */ import { serve } from "https://deno.land/std@0.184.0/http/server.ts";
 ...
 serve(async (req)=>{
   ...
   const { data: react, error } = await supabase.from("reply_reactions").insert({
     tidal_user_id,
     comment_id,
     emoji
